...
public class DropDownMenu extends RelativeLayout {
    ...
    //顶部菜单布局
    private LinearLayout tabMenuView,topMenuView;
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        topMenuView = new LinearLayout(context);
        LayoutParams params1 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        topMenuView.setOrientation(LinearLayout.VERTICAL);
        topMenuView.setBackgroundColor(context.getResources().getColor(R.color.white));
        topMenuView.setLayoutParams(params1);
        ...
        topMenuView.addView(tabMenuView,0);
        topMenuView.setId(1);

        //为tabMenuView添加下划线
        View underLine = new View(getContext());
        underLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(.0f)));
        underLine.setBackgroundColor(underlineColor);
        topMenuView.addView(underLine,1);
       ...
       // containerView.setId(1);
        ...
        addView(containerView, lp2);
        addView(topMenuView, 1);
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        //maskView.setBackgroundColor(transparent);
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        layoutParams.setMargins(dpTpPx(5),dpTpPx(5),dpTpPx(5),dpTpPx(5));
        tab.setLayoutParams(layoutParams);
        tab.setTextColor(this.getResources().getColor(R.color.blue));
        tab.setBackgroundResource(R.drawable.linearlayout_white);
        tab.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(menuUnselectedIcon), null);
        tab.setText(tabTexts.get(i));
        tab.setPadding(dpTpPx(0), dpTpPx(8), dpTpPx(5), dpTpPx(8));
        //添加点击事件
